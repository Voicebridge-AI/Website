  ...
  return (
    ...
    <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: 50 }}>
      ...
      <Col xs={12} sm={12} md={12} lg={11} xl={11} style={{ padding: 20 }}>
        ...
        <Navbar justify="true" fixed="top" variant={theme === 'light-theme' ? "light" : "dark"} style={{ padding: '0px 10px', backgroundColor: 'rgba(255, 255, 255, 1.0)' }}>
          ...
          {isPageWide && <Button variant="ghost" size="2" style={{ marginLeft: 10 }} onClick={() => window.location.href = 'https://cal.com/voicebridge/30-min'}><Calendar size={18} weight="bold" style={{ marginRight: 0 }} /> Book a demo</Button>}
        </Navbar>

        {/* Hero section */}
        <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: 40, minHeight: '60vh' }}>
          <Col xs={12} sm={11} md={11} lg={10} xl={9} style={{ textAlign: 'center', maxWidth: 900, marginBottom: 20, padding: isPageWide ? 30 : 0 }}>
            <Badge size="3" variant="soft" style={{ marginBottom: 10 }}>No more superficial answers</Badge>
            <h1 style={{ marginTop: 5 }}>Capture authentic insights with AI-moderated voice surveys</h1>
            ...
            <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: 10 }}>
              <Col xs={12} sm={11} md={11} lg={8} style={{ textAlign: 'center', padding: 0 }}>
                <Text size='4' color="gray" as='div' style={{ marginTop: 10 }}>Voicebridge's AI voice agents conduct and analyze in-depth interviews with your audience to gather rich, deep insights with emotional context and behavioral nuance.</Text>
        ...
        <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: 40 }}>
          <Col xs={12} sm={11} md={6} style={{ textAlign: 'left', maxWidth: 1200, marginBottom: 20, padding: isPageWide ? 30 : 0 }}>
            <h2>Two times higher completion rates</h2>
            <Text size='4' color="gray" as='div' style={{ marginTop: 10 }}>
              Traditional online surveys often see abandonment rates between 40% to 55%. In contrast, AI-moderated conversational voice surveys can achieve completion rates of 70% to 80%, attributed to personalized and engaging dialogue.
            </Text>
          </Col>
        ...
        <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: 40 }}>
          <Col xs={12} sm={11} md={6} style={{ textAlign: 'left', maxWidth: 1200, marginBottom: 20, padding: isPageWide ? 30 : 0 }}>
            <h2>Receive instant, multi-dimensional analysis</h2>
            <Text size='4' color="gray" as='div' style={{ marginTop: 10 }}>
