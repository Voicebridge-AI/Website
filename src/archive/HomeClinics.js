      ...
      <Col xs={12} sm={12} md={12} lg={11} xl={11} style={{ padding: 10 }}>
        ...
        <Navbar justify="true" fixed="top" variant={theme === 'light-theme' ? "light" : "dark"} style={{ padding: '5px 10px', backgroundColor: 'rgba(255, 255, 255, 1.0)' }}>
          ...
          <Nav className="ml-auto" style={{ marginRight: 0 }}>
            ...
            {false && isPageWide && <Nav.Link onClick={() => scrollEffect(pricingRef)}>Pricing</Nav.Link>}
          </Nav>
          {isPageWide && false &&
            <Button
              variant="ghost"
        ...
        <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'flex-start', marginLeft: 0, marginRight: 0, marginTop: 40, paddingLeft: isPageWide ? 40 : 0, paddingRight: isPageWide ? 40 : 0 }}>
          <Col xs={12} sm={6} md={6} lg={6} xl={4} style={{ padding: 20 }}>
            <Card style={{ padding: 20, height: '100%', backgroundColor: 'var(--accent-2)' }}>
              ...
              <Text size="3" color="gray" as="p" style={{ marginTop: 10 }}>
                Clinics miss 25% to 62% of phone calls, leading to an average of $300K to $1M in lost revenue. Ensure no potential patients slip through the cracks with Voicebridge's 24/7/365 AI receptionist that answers calls and books appointments.
              </Text>
            </Card>
          </Col>
          <Col xs={12} sm={6} md={6} lg={6} xl={4} style={{ padding: 20 }}>
            <Card style={{ padding: 20, height: '100%', backgroundColor: 'var(--accent-2)' }}>
              ...
              <Text size="3" color="gray" as="p" style={{ marginTop: 10 }}>
                Staff spend an average of 3 hours per day handling routine phone calls, costing over $15K annually in lost productivity. Voicebridge handles those calls while your team focuses on higher-value tasks and patient care.
              </Text>
            </Card>
          </Col>
          <Col xs={12} sm={6} md={6} lg={6} xl={4} style={{ padding: 20 }}>
            <Card style={{ padding: 20, height: '100%', backgroundColor: 'var(--accent-2)', color: 'black' }}>
              ...
              <Text size="3" color="gray" as="p" style={{ marginTop: 10 }}>
                Around 60% of patients abandon calls if wait times exceed one minute, leading to provider switching due to dissatisfaction. Voicebridge ensures every call is answered so patients don't get frustrated and go to competitors.
              </Text>
            </Card>
          </Col>
        </Row>

        <Row ref={benefitsRef} style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: isPageWide ? 40 : 40 }}>
          <Col xs={12} sm={12} md={12} lg={12} xl={12} style={{ textAlign: 'center' }}>
            <div style={{ padding: 20, background: 'linear-gradient(135deg, #e0f7fa 0%, #f8bbd0 50%, #e8f5e9 100%)' }}>
              <Image src="/assets/screenshots/dashboard.png" style={{ width: '100%', objectFit: 'contain', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }} />
            </div>
          </Col>
        </Row>
        ...
        <Row ref={featuresRef} style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: isPageWide ? 100 : 80 }}>
          <Col xs={12} sm={12} md={12} lg={12} xl={12} style={{ textAlign: 'center' }}>
            ...
            <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: 10 }}>
              <Col xs={12} sm={10} md={6} lg={5} xl={4} style={{ textAlign: 'center', paddingLeft: 0 }}>
                <Text size='4' color="gray">Voicebridge's receptionist is built to conduct personalized conversations at scale based on the needs of your clinic and patients.</Text>
              </Col>
            </Row>
          </Col>
        </Row>
        ...
        <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'flex-start', marginLeft: 0, marginRight: 0, backgroundColor: 'var(--accent-2)', paddingBottom: isPageWide ? 60 : 40 }}>
          <Col xs={12} sm={6} md={5} style={{ padding: 20 }}>
            <Card style={{ padding: 20, height: '100%', backgroundColor: 'var(--accent-2)' }}>
              ...
              <Text size="3" color="gray" as="div" style={{ marginTop: 10 }}>
                Provide your business information including business name, address, hours of operation, services your clinic offers, insurance information, and frequently asked caller questions so the Voicebridge receptionist can answer questions correctly and consistently.
              </Text>
            </Card>
          </Col>
          ...
          <Col xs={12} sm={6} md={5} style={{ padding: 20 }}>
            <Card style={{ padding: 20, height: '100%', backgroundColor: 'var(--accent-2)' }}>
              ...
              <Text size="3" color="gray" as="div" style={{ marginTop: 10 }}>
                Connect your preferred calendar system to the receptionist so it can check for availability and book appointments. Choose a voice, language, ambient sounds and other settings to personalize the receptionist to your clinic and your patients.
              </Text>
            </Card>
          </Col>
        ...
        <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: 60 }}>
          <Col xs={12} sm={11} md={10} lg={10} xl={9}>
            ...
            <Card style={{ padding: 20, marginBottom: 20 }}>
              ...
              <Text size="3" color="gray" as="div" style={{ marginTop: 10 }}>
                Voicebridge is an AI-powered phone answering receptionist that handles incoming calls from current and potential patients when you are busy, unavailable, or after business hours.
              </Text>
            </Card>
            ...
            <Card style={{ padding: 20, marginBottom: 20 }}>
              ...
              <Text size="3" color="gray" as="div" style={{ marginTop: 10 }}>
                Yes, you can personalize the receptionist's name, voice, and greeting to align with your brand.
              </Text>
            </Card>
            ...
            <Card style={{ padding: 20, marginBottom: 20 }}>
              ...
              <Text size="3" color="gray" as="div" style={{ marginTop: 10 }}>
                Absolutely. Voicebridge operates 24/7/365 to ensure no call is missed.
              </Text>
            </Card>
            ...
            <Card style={{ padding: 20, marginBottom: 20 }}>
              ...
              <Text size="3" color="gray" as="div" style={{ marginTop: 10 }}>
                If the receptionist cannot answer a question, it will take a detailed message and notify you for follow-up.
              </Text>
            </Card>
