      ...
      <Col xs={12} sm={12} md={12} lg={12} xl={12} style={{ padding: isPageWide ? 20 : 10 }}>
        ...
        <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: isPageWide ? 30 : 30 }}>
          <Col xs={12} sm={11} md={11} lg={10} xl={10} style={{ textAlign: 'center', maxWidth: 960, marginTop: isPageWide ? 0 : 40, padding: isPageWide ? 40 : 20 }}>
            <h3 style={{ color: 'var(--gray-11)' }}>👋 Goodbye traditional form surveys</h3>
            <h1 style={{ marginTop: 20 }}>AI interviewers collect authentic insights faster</h1>
            <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: 10 }}>
              <Col xs={12} sm={11} md={9} lg={8} xl={7} style={{ textAlign: 'center', padding: 0 }}>
                <Text size={isPageWide ? '4' : '3'} as='div' style={{ marginTop: 10 }}>Conduct & analyze 10s to 1000s of natural, human-like conversations to quickly understand what people really want.</Text>
                <Button variant="solid" size={isPageWide ? '4' : '3'} style={{ marginTop: 20 }} onClick={openBookDemo}>Book a demo <ArrowUpRight size={16} weight="bold" /></Button>
              </Col>
            </Row>
          </Col>
        </Row>
        ...
        <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: 0 }}>
          <Col xs={12} sm={11} md={11} lg={9} xl={8} style={{ textAlign: 'center', padding: 0 }}>
        ...
        {/* <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: isPageWide ? 30 : 40, minHeight: '60vh', borderRadius: 12 }}>
          <Col xs={12} sm={11} md={10} lg={6} xl={6} style={{ textAlign: 'left', maxWidth: 900, marginTop: isPageWide ? 0 : 40, marginBottom: 20, padding: isPageWide ? 40 : 20 }}>
            <h3 style={{ color: 'var(--gray-11)' }}>Goodbye traditional form surveys 👋</h3>
            <h1 style={{ marginTop: 10 }}>AI interviewers collect authentic insights faster</h1>
            <Row style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: 10 }}>
              <Col xs={11} sm={11} md={9} lg={9} style={{ textAlign: 'left', padding: 0 }}>
                <Text size={isPageWide ? '4' : '3'} as='div' style={{ marginTop: 10 }}>Use AI voice agents to quickly conduct & analyze 10s to 1000s of natural, human-like conversations to understand what people really want.</Text>
        ...
        <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: isPageWide ? 140 : 120, backgroundColor: '#1a1a1a', padding: '80px 20px', borderRadius: 12 }}>
          <Col xs={12} sm={11} md={11} lg={10} xl={10} style={{ textAlign: 'center', maxWidth: 800 }}>
            <h2 style={{ color: 'white' }}>Start listening to your audience, faster and at scale.</h2>
            <Row style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginLeft: 0, marginRight: 0, marginTop: 0 }}>
